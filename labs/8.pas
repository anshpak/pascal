...
begin
        ...
        for i := 1 to k do
        begin
                if(y.a[i] < x.a[i] + p) then
                begin
                        y.a[i + 1] := y.a[i + 1] - 1;
                        result.a[i] := (10 + y.a[i] - x.a[i] - p) mod 10;
                        p := (10 + y.a[i] - x.a[i] - p) div 10;
                end
                else
                begin
                        result.a[i] := (y.a[i] - x.a[i] - p) mod 10;
                        p := (y.a[i] - x.a[i] - p) div 10;
                end;
        end;
        for i := k + 1 to l do
        begin
        ...
        result.len := l;
        while(result.a[result.len] = 0) do
