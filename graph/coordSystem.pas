...
begin
        ...
        while(y0 + i * 20 < getmaxy) do begin
                {Можно было добавить условие пока y0 - i * 20 > 0, но оно избыточное, так как линии рисуются
                симметрично и рисование прекратится с обоих концов, когда будет достигнута максимальная граница}
